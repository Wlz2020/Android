package com.example.imanufacturing_test;
...
//            intent.putExtra("fromWhich", "webViewUrl");
//            intent.putExtra("replyID", "replyID");
            intent.setClass(mActivity, TestActivity1.class);
            mActivity.startActivity(intent);
        }
...
//            intent.putExtra("fromWhich", "webViewUrl");
//            intent.putExtra("replyID", "replyID");
            intent.setClass(mActivity,TestActivity2.class);
            mActivity.startActivity(intent);
        }
        @JavascriptInterface
...
//            intent.putExtra("fromWhich", "webViewUrl");
//            intent.putExtra("replyID", "replyID");
            intent.setClass(mActivity,TestActivity3.class);
            mActivity.startActivity(intent);
        }
        @JavascriptInterface
...
//            intent.putExtra("fromWhich", "webViewUrl");
//            intent.putExtra("replyID", "replyID");
            intent.setClass(mActivity,TestActivity4.class);
            mActivity.startActivity(intent);
        }
        @JavascriptInterface
...
//            intent.putExtra("fromWhich", "webViewUrl");
//            intent.putExtra("replyID", "replyID");
            intent.setClass(mActivity,TestActivity5.class);
            mActivity.startActivity(intent);
        }
        @JavascriptInterface
...
//            intent.putExtra("fromWhich", "webViewUrl");
//            intent.putExtra("replyID", "replyID");
            intent.setClass(mActivity,TestActivity6.class);
            mActivity.startActivity(intent);
        }
        @JavascriptInterface
...
//            intent.putExtra("fromWhich", "webViewUrl");
//            intent.putExtra("replyID", "replyID");
            intent.setClass(mActivity,TestActivity7.class);
            mActivity.startActivity(intent);
        }
